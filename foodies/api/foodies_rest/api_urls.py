...
urlpatterns = [
    ...
    path("reviews/<int:review_id>/images/", api_list_create_review_images, name="api_list_create_review_images"),
    path("reviews/images/", api_list_create_review_images, name="api_list_create_review_images"),
    ...
    path("eateryImages/<int:eatery_image_entity_id>/", api_get_specific_eatery_image_vo, name="api_get_specific_eatery_image_vo")
]
